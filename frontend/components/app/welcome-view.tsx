  ...
  return (
    ...
    >
      <section className="bg-background flex flex-col items-center justify-center text-center">
        {state === 'ready' && (
          <>
            {/* Day 8: Profile Avatar */}
            <div className="mb-5 rounded-full overflow-hidden border-4 border-teal-100 dark:border-teal-900/50 shadow-md">
              <img
                src="/profile-avatar.png"
                alt="Anisha - Medical Assistant"
                className="w-[136px] h-[136px] object-cover"
              />
            </div>

            {/* Day 8: Assistant Name */}
            ...
            <p className="text-teal-600 dark:text-teal-400 font-medium text-sm uppercase tracking-wider mb-6">
              Verified Medical Assistant
            </p>

            {/* Day 8: Updated Description */}
            <p className="text-muted-foreground text-sm max-w-sm mb-8 leading-relaxed">
              Empowering you with verified health information and facility
              lookups. Start a secure, real-time voice consultation with
              Anisha.
            </p>
            ...
            {/* Day 7: Outbound Medication Reminder Call */}
        ...
        {state === 'denied' && (
          <>
            ...
            <p className="text-muted-foreground text-sm max-w-sm mb-8 leading-relaxed">
              Your microphone permission is currently blocked. Please allow
              microphone access in your browser settings to talk to Anisha.
            </p>
